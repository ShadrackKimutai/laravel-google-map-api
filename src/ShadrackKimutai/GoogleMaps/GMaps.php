<?php namespace ShadrackKimutai\GoogleMaps;

use ShadrackKimutai\GoogleMaps\Containers\isInsidePolygon;
...
class GMaps
{
    ...
    public function create_map()
    {
        ...
        if ($this->maps_loaded == 0) {
            ...
            <script type="text/javascript" src="'.asset('libs/ShadrackKimutai/GMaps/markerclusterer.js').'"></script >
                    ';
            }
        }
        if ($this->jsfile == "") {
